...
class GoogleMapsService:
    ...
    def _generate_realistic_coordinates(self, address: str) -> Tuple[float, float]:
        ...
        if address == "1707 Smart Street, Leesville, LA 71446":
        ...
        elif "Jasper" in address or "TX 75951" in address:
            print(f"DEBUG: Exact Jasper depot match")
            return (30.9204, -94.0154)
        else:
            ...
            elif "Jasper" in address or "TX 759" in address:
                base_lat = 30.9204
                base_lng = -94.0154
                lat_range = 0.08
                lng_range = 0.08
                print(f"DEBUG: Jasper region distribution")
            else:
                base_lat = 31.1435
                base_lng = -93.2607
                lat_range = 0.08
    ...
    def _calculate_simplified_distance_matrix(self, locations: List[str], depot_penalties: bool = True) -> List[List[float]]:
        ...
        for i, location in enumerate(locations):
            if location == "1707 Smart Street, Leesville, LA 71446":
            ...
            elif "Jasper" in location or "TX 75951" in location:
                coords.append((30.9204, -94.0154))
            else:
                import hashlib
                ...
                elif "Jasper" in location or "TX 759" in location:
                    base_lat, base_lng = 30.9204, -94.0154
                else:
