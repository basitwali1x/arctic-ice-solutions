...
export function MobileNavigation() {
  ...
  const allNavItems = [
    { path: '/mobile/dashboard', icon: Home, label: 'Dashboard', roles: ['customer'] },
    { path: '/mobile/customer', icon: User, label: 'Orders & Billing', roles: ['customer'] },
    { path: '/mobile/profile', icon: User, label: 'Profile', roles: ['customer'] },
  ];
